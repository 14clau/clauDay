...
**ClauDAY** es una página web interactiva diseñada para ayudarte a **organizar tu tiempo y mantener la concentración** mientras estudias o trabajas. Combina varias herramientas en un mismo lugar:

- **Temporizador Pomodoro** ⏱  
  Controla tus sesiones de estudio y descansos usando la técnica Pomodoro. Permite alternar entre enfoque, descansos cortos y descansos largos.
...
- Fuentes: [Google Fonts – Playfair Display](https://fonts.google.com/specimen/Playfair+Display), [DM Sans](https://fonts.google.com/specimen/DM+Sans), [DM Mono](https://fonts.google.com/specimen/DM+Mono)
